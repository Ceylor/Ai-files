    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      <div>
        ...
        <input
          ...
          className="glass w-full rounded-xl border border-slate-300 px-3 py-2 text-sm text-slate-800 placeholder-slate-400 focus:border-neon-cyan focus:outline-none focus:ring-2 focus:ring-neon-cyan/30 dark:border-white/10 dark:text-white"
        />
      </div>
